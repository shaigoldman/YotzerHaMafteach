...
rambam_sections = [ 'יסודי התורה', 'דעות', 'תלמוד תורה', 'עבודה זרה', 'תשובה', 
           ...
           'תרומות', 'מעשרות', 'מעשר שני', 'מע״ש', 'מעשר שני ונטע רבעי', 'נטע רביעי',
           'נ״ר', 'ביכורים', 'שמיטה', 'יובל', 'שאר מתנות כהונה',
           'בית הבחירה', 'כלי המקדש', 'ביאת המקדש', 'איסורי המזבח', 'איה״מ',
...
sfarim_chizonim = [ 'מקדש דוד', 'בה״ג', 'בעל הלכות גדולות', 'הלכות גדולות', 'מנחת חינוך', 
                    ...
                    'קובץ שיעורים', 'קבצ״ש',
                    'תרומת הדשן', 'השגות הרמב"ן',
                    'מכילתא', 'תורת כהנים', 'ספר המצוות לרמב"ם', 
